...
trait Dependencies {
  ...
  // Json serialization
  val jackson         = "com.fasterxml.jackson.module" %% "jackson-module-scala" % "2.4.0"
  val jacksonDatabind = "com.fasterxml.jackson.core" % "jackson-databind" % "2.4.0"
